...
module view_new() {
    ...
    color("DarkGrey") {
        ...
        translate([
            70/2 + 120/2, corner_y_offset - 89, 30/2
        ])
        rotate([0, 0, -90])
        render()
        extention_cross();
    ...
    // y rod holders, z motor holders and top parts
    color("white") {

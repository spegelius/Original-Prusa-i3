...
module dollo_y_idler_body() {
    ...
    difference() {
        ...
        hull() {
            translate([4.2, 5, 16])
            rotate([0, 90, 0])
            cylinder(d=22, h=19.6, $fn=50);

            translate([4.2, 3, -9])
            rotate([0, 90, 0])
            cylinder(d=19, h=19.6, $fn=50);
        }
        ...
        translate([0, 40/2, 26.2])
        rotate([0, 45, 0])
        cube([10, 40, 20], center=true);

        translate([28, 40/2, 26.2])
        rotate([0, -45, 0])
        cube([10, 40, 20], center=true);
...
module dollo_y_idler_arm() {
    difference() {
        ...
        translate([4, 0, 0])
        rotate([0, 90, 0])
        cylinder(d=22, h=11, $fn=50);

        translate([-0.1, 0, 0])
        rotate([0, 90, 0])
        cylinder(d=3.5, h=21, $fn=20);

        translate([19/2, -14.5, -11])
        rotate([-8, 0, 0])
        union() {
